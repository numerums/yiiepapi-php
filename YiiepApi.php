 ...
 * @author Elom Raydino
 */
require_once 'numerums/ApiClient.php';
...
class YiiepApi extends \ApiClient{
     ...
     */
    public function __construct($testmode = false, $publicKey = NODEID, $privateKey = NODEKEY) {
        parent::__construct($testmode, $publicKey, $privateKey);
    }
    ...
    public function checkBill($billHash){
        ...
        return $this->isSuccess($this->query('bstate', $param));
    }
    ...
    public function accountState(){
        ...
        return $this->isSuccess($this->query('astate', $param));
    }
